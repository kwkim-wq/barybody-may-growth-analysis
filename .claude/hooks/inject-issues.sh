#!/bin/bash
REPO="kwkim-wq/barybody-may-growth-analysis"
...
LAST_COMMIT=$(git -C "/Users/kwkim/Desktop/barybody/260429_데이터 AI_ver_2/5월 매출 상승세 원인 분석" log --oneline -1 2>/dev/null)

echo "[may-growth-analysis | 열린이슈 ${ISSUE_COUNT}개] $ISSUE_LINE | 최근커밋: $LAST_COMMIT"
echo ""
echo "======================================================"
